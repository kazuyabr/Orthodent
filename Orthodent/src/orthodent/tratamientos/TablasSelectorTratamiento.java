 ...
 * @author msanhuezal
 */
public class TablasSelectorTratamiento extends javax.swing.JPanel {
    ...
    private int tratamientoSelected;
  
    public TablasSelectorTratamiento() {
        tratamientoSelected = -1;
        initComponents();
        this.iniciarTablaCategoria1();                    
    }
        
    public int getTratamientoSelected() {
        return tratamientoSelected;
    }

    public void setTratamientoSelected(int tratamientosSelected) {
        this.tratamientoSelected = tratamientosSelected;
    }    
    ...
    private void iniciarTablaTratamientos(int aux) {
        ...
        this.columnasNombreTratamientos = new String [] {"Nombre"};
        this.updateModeloTratamientos(categoria2Selected);
